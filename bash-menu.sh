...
# Define the function to encapsulate the menu script
menu_setup() {

    # Public Variables to Override
    # These can be passed into menuInit() rather than be set as global script variables
    #
    ...
    menu_HandleInput() {
        ...
        if [[ $key = $upKey ]]; then
            ...
            # See if we want to jump to a menu item
